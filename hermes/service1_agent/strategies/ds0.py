...
class DebitSpreads0DTE(ZeroDTEMixin, CreditSpreadStrategy):
    PRIORITY = 6
    NAME = "DS0"
    ...
    # Time/quote/ATR helpers (_now_et, _mid, _spot, _today_open, _atr) come
    # from ZeroDTEMixin — shared with DS02, behaviour pinned by this file's
    # test suite.
