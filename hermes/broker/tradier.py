...
class TradierBroker:
    ...
    def analyze_symbol(self, symbol: str, period: str = "6m") -> Dict[str, Any]:
        ...
        # Drop the leading NaN from .shift(1) before std, otherwise any rolling
        # window that includes position 0 produces NaN — which later fails JSON
        # serialization in the analytics endpoint.
