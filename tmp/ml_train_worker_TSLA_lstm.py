...
try:
    ...
    # Load data
    df = joblib.load(r'/Users/laguz/Git/LaguzTechInvestment/tmp/ml_tmp_df_TSLA_lstm.pkl')
    top_features = joblib.load(r'/Users/laguz/Git/LaguzTechInvestment/tmp/ml_tmp_features_TSLA_lstm.pkl')
