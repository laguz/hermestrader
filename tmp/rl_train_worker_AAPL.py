...
try:
    df = joblib.load(r'/Users/laguz/Git/LaguzTechInvestment/tmp/ml_tmp_df_AAPL.pkl')
    top_features = joblib.load(r'/Users/laguz/Git/LaguzTechInvestment/tmp/ml_tmp_features_AAPL.pkl')
    
    predictor = RLPricePredictor('AAPL', df, top_features, 'models')
